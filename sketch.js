...
player = createSprite(canW-1200, canH-300, 50, 50);
...
if(keyDown("UP_ARROW")&&player.y>canH-500){
  player.y = player.y-30
}
if(keyDown("DOWN_ARROW")&&player.y<canH-150){
 player.y = player.y+30
}
...
function zombi(){
    ...
    zombi1 = createSprite(canW - 150, canH - 250,50,50);
    zombi1.addImage(zombis)
    zombi1.scale = 0.2
    zombi1.velocityX = -8
    zombi1.y = Math.round(random(canH - 250,canH - 480));
    zombies.add(zombi1)
...
function vida(){
  push();
  fill("white");
  rect(canW/2 - 150, 50 , 200, 20);
  fill("green");
  rect(canW/2 - 150, 50 , live, 20);
  if(live < 100){
    fill ("yellow");
    rect(canW/2 - 150, 50 , live, 20)
  }
...
function zombi_2(){
    ...
    zombi2 = createSprite(canW - 150, canH - 250,50,50);
    zombi2.addImage(zombi2img)
    zombi2.scale = 0.1
    zombi2.velocityX = -8
    zombi2.y = Math.round(random(canH - 250, canH - 480));
    zombi2g.add(zombi2)
  
}

function zombi_3(){
  zombi3 = createSprite(canW - 150, canH - 250,50,50);
  zombi3.addImage(zombi3img)
  zombi3.scale = 0.11
  zombi3.velocityX = -8
  zombi3.y = Math.round(random(canH - 250, canH - 480));
  zombi3g.add(zombi3)
}
